module github.com/nutanix-cloud-native/cloud-provider-nutanix/test/e2e
...
require (
	...
	sigs.k8s.io/cluster-api v1.9.0-rc.0.0.20250228131023-67245f572cbe
	sigs.k8s.io/cluster-api/test v1.9.0-rc.0.0.20250228131023-67245f572cbe
...
replace (
	// CVE fixes for https://github.com/advisories/GHSA-9763-4f94-gfch
